    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 gap-px bg-border sm:grid-cols-2 lg:grid-cols-4">
            {processSteps.map((step) => (
              <div key={step.step} className="bg-card/85 p-6 backdrop-blur-sm md:p-8">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {credibilityPoints.map((point) => (
              <div
                key={point.title}
                className="border border-border/50 bg-card/85 p-6 transition-colors hover:border-primary/50 backdrop-blur-sm md:p-7"
              >
      ...
      <section className="border-b border-border/50 py-16 md:py-20">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16 lg:px-8">
          ...
          <div className="border border-border/50 bg-card/85 p-6 backdrop-blur-sm md:p-8">
      ...
      <section className="py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 gap-5 lg:grid-cols-3">
            {faqItems.map((item) => (
              <div key={item.title} className="border border-border/50 bg-card/85 p-6 backdrop-blur-sm md:p-7">
